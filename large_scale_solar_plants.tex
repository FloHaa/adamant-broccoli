...
It must be noted, that the cycle lifetime of all batteries is highly effected by the charging and discharging settings and can thereby vary a lot.
...
\begin{figure}[htbp]  
\centering
\includegraphics[width=0.7\linewidth]{FIG/TCC_EES}
