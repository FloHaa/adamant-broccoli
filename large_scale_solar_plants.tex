...
\caption[Installed capacity for grid connected storage.]{Installed capacity for grid connected storage \cite{IEA2015}.}\label{EESgridCapacity}
\end{figure}


\begin{figure}[htbp]  
\centering
\includegraphics[width=0.4\linewidth]{FIG/EEStechnologies}
\caption[.]{\cite{IEA2014c}.}\label{EEStechnologies}
\end{figure}

\begin{figure}[htbp]  
\centering
\includegraphics[width=1\linewidth]{FIG/EESgridBattery}
\caption[Economic and technical development of grid-scale battery storage caracteristics.]{Economic and technical development of grid-scale battery storage caracteristics \cite{IEA2015}.}\label{EESgridBattery}
\end{figure}
