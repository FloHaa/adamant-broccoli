...
\begin{acronym}[XXXXX]
    ...
    \acro{EES}[EES]{electrical energy storage}
    \acro{EPC}[EPC]{engineering, procurement and construction}
    ...
    \acro{li-ion}[li-ion]{lithium-ion}  
    ...
    \acro{OCGT}[OCGT]{open cycle gas turbine}
