...
EES PCS costs & & 615 & USD/kW & \cite{Zakeri2015} \\ 
EES battery bank costs & &300 & USD/kWh & \cite{Nykvist2015} \\ 
EES battery bank replacement costs & & 150 & USD/kWh & \cite{Zakeri2015} \\ 
...
Figure \ref{PVwithoutEESanual} visualizes the resulting annually load covering behavior. It can be seen, that the system can't cover the prescribed load at all. As it is usually for a solar powered system without storage the energy production standstill during the night time. 
...
\end{figure}
The simulated PV system had a annual energy production during the first year of about 233.69~GWh


The here shown annual average PV system power output covers about 32.9~\% of the prescribed load in the first year of the system.
...
\hline
\end{tabular}
\caption[.]{.}\label{tbl: PVwithoutEESresult}
\end{table}
\pagebreak
\subsubsection{Load curve covering}
