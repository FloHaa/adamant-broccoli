\chapter{Solar plant design documentation} \label{documentary}
\section{CR plant simulation design documentation}\label{CRdocumentary}
\begin{figure}[!htbp]
        \centering   
...
\end{figure}
\pagebreak
\section{PTC plant simulation design documentation}\label{PTCdocumentary}
...
\end{figure}
\pagebreak
\section{PV plant simulation design documentation}\label{PVdocumentary}
