...
\kurzfassung{Durch steigende Elektrizitätsnachfrage bei gleichzeitigen Lieferengpässen benötigt das südafrikanische Elektrizitätssystem derzeit dringend neue Stromerzeugungskapazitäten. Es wird ermittelt, inwieweit solare Stromerzeugung in Engpassfällen eingesetzt werden kann. Dafür wurden große photovoltaische (PV) und solarthermische Kraftwerke mit entsprechenden Energiespeichern verglichen. Solarthermische Kraftwerke werden dabei mit einem thermischen Energiespeicher ausgestattet, welche dem Stand der Technik entspricht. Die Regelbarkeit eines einzelnen PV-Kraftwerkes durch einen elektrischen Energiespeicher zu ermöglichen ist außergewöhnlich und wurde bisher nicht umgesetzt. Der Vergleich beinhaltet stündliche Zeitreihensimulationen der solarthermischen Kraftwerke mit thermischen Energiespeichern gegenüber dem PV-Kraftwerk mit elektrischen Energiespeicher, welche mit variierenden Solarfeldgrößen und Speichervolllaststunden modeliert werden. Dabei basiert der Vergleich der Anlagenleistung auf einem zuvor definierten Ausgangsleistung. Die Kraftwerke werden außerdem nach ihren Stromgestehungskosten untersucht, wobei auch die langfristige Kostenentwicklung betrachtet wird.
